    ...
    <div style=" position:relative;height:100%">
        <div class="enroll_desc">
            ...
            <div class="enroll_desc_price clearfix">
                ...
                <span v-if="details.train_price.price>0" class="number">￥
                    <label>{{details.train_price.price*0.01}} x {{details.people}}</label>
                </span>
        ...
        <div class="apply clearfix">
            ...
            <span v-if="details.train.price>0" class="apply_price">
                ...
                <i>{{details.train_price.price*details.people *0.01}}</i>元
            </span>
...
export default {
    ...
    methods: {
        ...
        pay() {
            ...
            if (self.details.train_price.price > 0) {
                axios.post('/api/charge/trains',
                    {
                        paymentable_id: self.details.id,
                        open_id: localStorage.getItem('openid') || 'oHMjq1EyyIVJj7lQdXAJWGdzGMrc',
