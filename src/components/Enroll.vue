    ...
    <div>
        <div class="enroll_desc">
            ...
            <div class="enroll_desc_price">
                ...
                <span class="number">￥
                    <label>{{details.price*$route.params.people*0.01}}</label>
                </span>
            </div>
        </div>
        <div class="join">
            <group>
                ...
                <x-input title="手机" v-model="order.mobile" placeholder="请填写" name="mobile" keyboard="number" is-type="china-mobile" required :show-clear="true" text-align="right" placeholder-align="right"></x-input>
